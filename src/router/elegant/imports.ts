...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  env_cvm: () => import("@/views/env/cvm/index.vue"),
  "env_deploy-unit": () => import("@/views/env/deploy-unit/index.vue"),
  env_elb: () => import("@/views/env/elb/index.vue"),
  "env_mysql-enhance": () => import("@/views/env/mysql-enhance/index.vue"),
  env_oracle: () => import("@/views/env/oracle/index.vue"),
  env_redis: () => import("@/views/env/redis/index.vue"),
  env_subsystem: () => import("@/views/env/subsystem/index.vue"),
  env_tenant: () => import("@/views/env/tenant/index.vue"),
  env_vpc: () => import("@/views/env/vpc/index.vue"),
  ...
  tool_json: () => import("@/views/tool/json/index.vue"),
};
