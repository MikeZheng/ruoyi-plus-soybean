...
function handleDownloadTemplate() {
  download(
    '/env/mysqlEnhance/importTemplate',
    {},
    `mysqlEnhance信息_${$t('common.importTemplate')}_${new Date().getTime()}.xlsx`
  );
}
...
<template>
  ...
  >
    <NUpload
      ...
      :action="`${baseURL}/env/mysqlEnhance/importData`"
      :headers="headers"
      :data="data"
      :max="1"
      :file-size="50"
