...
function handleDownloadTemplate() {
  download('/env/oracle/importTemplate', {}, `oracle信息_${$t('common.importTemplate')}_${new Date().getTime()}.xlsx`);
}
...
<template>
  ...
  >
    <NUpload
      ...
      :action="`${baseURL}/env/oracle/importData`"
      :headers="headers"
      :data="data"
      :max="1"
      :file-size="50"
