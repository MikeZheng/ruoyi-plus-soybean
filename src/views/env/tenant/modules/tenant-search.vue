...
const model = defineModel<Api.Env.TenantSearchParams>('model', { required: true });
      ...
      <NCollapseItem :title="$t('common.search')" name="user-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="80">
          <NGrid responsive="screen" item-responsive>
            ...
            <NFormItemGi span="24 s:12 m:6" label="租户AppId" path="appId" class="pr-24px">
              <NInput v-model:value="model.appId" placeholder="请输入租户AppId" />
            </NFormItemGi>
            <NFormItemGi span="24 s:12 m:6" label="租户账号" path="accountId" class="pr-24px">
